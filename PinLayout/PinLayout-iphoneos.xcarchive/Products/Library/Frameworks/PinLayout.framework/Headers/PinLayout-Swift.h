...
typedef SWIFT_ENUM(NSInteger, Fit, open) {
  FitWidth = 0,
  FitHeight = 1,
  FitWidthFlexible = 2,
  FitHeightFlexible = 3,
...
typedef SWIFT_ENUM(NSInteger, LayoutDirection, open) {
...
typedef SWIFT_ENUM(NSInteger, PinSafeAreaInsetsDidChangeMode, open) {
...
typedef SWIFT_ENUM(NSInteger, WrapType, open) {
